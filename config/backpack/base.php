...
return [
    ...
    */
    ...
    'project_logo'   => '<b>Notes</b>Portal',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-teal border-0 navbar navbar-color ',
    ...
    */
    ...
    'registration_open' => env('BACKPACK_REGISTRATION_CLOSE', env('APP_ENV') === 'local'),
